...
export default function Home() {
  ...
  return (
      <div className="mainlist">
        <main>
          <header>
            <div className="DivImage">
              <Image alt="Profile" src={gravatar} width={90} height={90} />
            </div>
          </header>
          <div className="Badge">
        ...
        <main className="ml-3 mr-3 mobile-hidden">
          <h3 className="text-xl font-bold pt-5 pb-5">Project</h3>
          ...
          <div className="listflex">
            ...
            <Link href="https://github.com/Sqlare/QloatMobile" className="ml-1">/ QloatMobile 🔒</Link>
          </div>
          <div className="listflex">
            <Link href="https://sqlare.com">
              <svg
          ...
          <div className="listflex">
            <Link href="https://imnyang.xyz">
              <Image alt="Profile" src={gravatar} width={24} height={24} />
            </Link>
            <Link href="https://github.com/imnyang/profile" className="ml-1">/ profile</Link>
          </div>
          <div className="listflex">
            <Link href="https://imnyang.xyz">
              <Image alt="Profile" src={gravatar} width={24} height={24} />
            </Link>
            <Link href="https://github.com/imnyang/discord-voice-rec" className="ml-1">/ discord-voice-rec</Link>
          </div>
        </main>
      </div>
  );
